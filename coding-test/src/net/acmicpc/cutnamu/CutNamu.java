...
public class CutNamu {
	
	private static String input = "4 7" + System.lineSeparator() + "20 15 10 17";
	
	public int getCuttersHeight(String input) throws Exception {
		int treeCount = 0;
		int myTreeLen = 0;
		int[] treeLenArr = null;
		{
...
//		System.out.println("testsum=" + testsum);
	...
	public static void main(String[] args) throws Exception {
		long start = System.currentTimeMillis();
		CutNamu cn = new CutNamu();
		System.out.println(cn.getCuttersHeight(input));
		long end = System.currentTimeMillis();
